...
export default function Hero({ siteConfig }: HeroProps) {
  ...
  const part1 = dotIdx >= 0 ? rawTitle.slice(0, dotIdx + 1) : rawTitle
  const part2 = dotIdx >= 0 ? rawTitle.slice(dotIdx + 1).trim() : ''
    ...
    <>
        ...
        <motion.div style={{ opacity: heroOpacity, y: heroY }} className="relative z-10 max-w-5xl mx-auto w-full">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            <div>
              ...
              >
                ...
                {part2 && (
                  <>
                    <br />
                    <span className="text-[#2F7D6B]">{part2}</span>
                  </>
                )}
              </motion.h1>
              ...
              >
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} transition={spring}>
                  <Link
                    href="/servicios"
                    className="inline-flex items-center justify-center bg-white text-[#0A0A0A] border border-black/10 font-semibold text-[15px] px-7 py-3.5 rounded-full hover:bg-[#F5F5F7] transition-colors w-full sm:w-auto"
                  >
                    Conocer servicios
                  </Link>
                </motion.div>
            ...
            >
              ...
              <div className="aspect-[5/4] rounded-3xl overflow-hidden bg-gradient-to-br from-[#DCEFE8] to-[#b8ddd0] flex items-center justify-center relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-24 h-24 opacity-20">
                    <LogoImage size={96} className="opacity-40" />
                  </div>
                </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  { n: '8', label: 'Especialidades' },
                  { n: '+', label: 'Servicios integrales' },
                  { n: '100%', label: 'Habilitado' },
                ].map((stat) => (
      ...
      <section className="py-14 md:py-20 px-5 bg-[#F5F5F7]">
        <div className="max-w-5xl mx-auto">
          <motion.p
            ...
            className="text-center text-[11px] text-[#86868b] font-semibold uppercase tracking-[0.2em] mb-7"
          >
            Áreas de atención
          </motion.p>
      ...
      <section className="py-20 md:py-28 px-5 bg-white overflow-hidden">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <p className="text-[clamp(1.4rem,3.8vw,2.4rem)] font-light leading-[1.4] text-[#0A0A0A] tracking-tight mb-5">
              "{quote}"
            </p>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
              <div className="max-w-lg">
                <h2 className="text-[clamp(1.8rem,4.5vw,2.8rem)] font-semibold tracking-tight leading-tight mb-3">
                  {ctaTitle}
                </h2>
