...
export default function ServiciosClient({ heroTitle }: Props) {
          ...
          <StaggerList className="areas">
            {AREAS.map((a) => (
              ...
              <HoverCard className="area">
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%', fontSize: 13, color: 'var(--sage-deep)', fontWeight: 600, padding: '0 8px', textAlign: 'center' }}>
                    {a.name}
                  </div>
                </AdminImageUpload>
