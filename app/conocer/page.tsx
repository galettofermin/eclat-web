        ...
        <div className="wrap">
          <div className="split">
            ...
            <div className="reveal">
              ...
              <p>
                A lo largo de años de práctica observamos que muchas situaciones que atravesaban niños,
                adolescentes, familias e instituciones no podían comprenderse de manera aislada: lo que
                aparecía en la escuela solía vincularse con aspectos subjetivos, familiares y sociales,
                y muchos padecimientos de la salud mental encontraban expresión en lo educativo.
              </p>
              <p>
                ÉCLAT surge del deseo de crear un espacio capaz de articular esos campos. Hoy somos un
          ...
          <div className="split">
            <div className="reveal">
              ...
              <p style={{ marginTop: '18px' }}>
                Nuestro trabajo no consiste en aplicar soluciones estandarizadas, sino en construir
            ...
            <div className="reveal">
              ...
              <p style={{ marginTop: '16px' }}>
                Vivimos profundas transformaciones en los modos de aprender, vincularse y habitar las
                instituciones. Las escuelas, las familias y los profesionales enfrentan desafíos cada
        ...
        <div className="wrap">
          ...
          <div className="mv reveal" style={{ marginTop: '22px' }}>
            <div className="mv__card">
              ...
              <p>
                Acompañar a personas, familias, profesionales e instituciones mediante prácticas
                clínicas, educativas y formativas orientadas por la singularidad y el trabajo
            ...
            <div className="mv__card">
              ...
              <p>
                Consolidar a ÉCLAT como una institución de referencia en salud mental, educación y
        ...
        <div className="wrap">
          ...
          <div className="dirs reveal">
            ...
            <div className="dir">
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%', color: 'var(--sage-deep)', fontSize: 13, fontWeight: 600 }}>
                  Foto
                </div>
              </AdminImageUpload>
              <div>
      ...
      <section className="diff">
        <div className="wrap reveal">
          ...
          <div>
            ...
            <p>
              La diferencia de ÉCLAT no está sólo en los servicios, sino en articular disciplinas
              —salud mental, educación, familias e instituciones— para construir respuestas frente
